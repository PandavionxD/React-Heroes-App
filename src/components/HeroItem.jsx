...
export const HeroItem = ({hero}) => {
  ...
  return (
    <div className="mx-auto shadow-md rounded-md p-3" > 
        ...
        <h2 className="text-center my-2 text-indigo-600 text-xl" >{hero.superhero}</h2>
        <Link className="w-full block text-center outline outline-indigo-600 outline-1 rounded-md text-white bg-indigo-600
